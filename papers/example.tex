% Paper template - use as a starting point for structuring a paper.
...
% The \documentclass line will need to be updated to use the template for
% the conference/journal chosen, rather than the standard article class.
% Standard IEEE and ACM templates are included, but check the submission
% instructions for your chosen venue.
%
% For the standard LaTeX article style, use:
%   \documentclass[twocolumn,a4paper]{article}
%
% For IEEE style (http://www.ieee.org/conferences_events/conferences/publishing/templates.html)
% use:
%   \documentclass[conference]{IEEEtran}
%
% For the ACM style (http://www.acm.org/sigs/publications/proceedings-templates) 
% use:
%   \documentclass{sig-alternate}
% or
%   \documentclass{sig-alternate-10pt}
% The sig-alternate.cls and sig-alternate-10pt.cls files included here have
% been edited to remove \usepackage{epsfig}, as the epsfig package has long
% been deprecated in favour of graphicx, and to fix other bugs (without any
% change to the output formatting).
\documentclass[twocolumn,a4paper]{article}
...
\ifpdf
  % The microtype package offers improved typography when used with pdflatex.
  % This has the side effect of fixing the broken justification when the ACM
  % style is used with pdflatex. It also tends to increase the amount of text
  % that can fit on a page sligthly. Only works with PDF output.
...
%  \numberofauthors{2}
%  \author{
%    \alignauthor A. N. Other\\
%    \affaddr{University of Glasgow}\\
%    \email{a.n.other@glasgow.ac.uk}
%    \alignauthor Colin Perkins\\
%    \affaddr{University of Glasgow}\\
...
%==================================================================================================
% Set the bibliography style. The IEEEtran-doi.bst file is included here,
% and is a modification to the standard style to include the DOI, if it's
% present. The abbrvurl style comes from https://www.ctan.org/pkg/urlbst,
% and is included in most standard TeX distributions, and adds DOI support 
% to the abbrv style.
%\bibliographystyle{IEEEtran-doi} % For IEEE style
\bibliographystyle{abbrvurl}     % For article and sig-alternate styles
