...
% class for your chosen venue, rather than the standard LaTeX article
% class. The IEEE and ACM templates are included in the lib/tex/inputs
% subdirectory and the bin/latex-build.sh script is set to search this
